...
if __name__ == "__main__":
    ...
    print("🤖 বট সফলভাবে ২৪ ঘণ্টা লাইভ এবং আনলিমিটেড অটো-রিস্টার্ট মোডে রান হচ্ছে...")
    
    # অটো-রিকানেক্ট ও ফল্ট টলারেন্স লুপ (নেটওয়ার্ক ফ্লাকচুয়েশন বা ডিসকানেক্ট হ্যান্ডেল করার জন্য)
    while True:
        try:
            app.run_polling(drop_pending_updates=True)
        except Exception as e:
            print(f"⚠️ সংযোগ বিচ্ছিন্ন হয়েছে: {e}. ৫ সেকেন্ড পর নিজে থেকেই রিকানেক্ট হচ্ছে...")
            time.sleep(5)
