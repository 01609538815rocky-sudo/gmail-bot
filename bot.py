...
def send_welcome(message):
    ...
    welcome_text = (
        ...
        "নিচের মেনു থেকে কাজ শুরু করুন বা আপনার ব্যালেন্স চেক করুন:"
    )
...
def handle_messages(message):
    ...
    if message.text == "💎 My Balance":
        ...
        # এডমিন বা চ্যানেলে বাটন সহ নোটিফিকেশন পাঠানোর ব্যবস্থা
        ...
        bot.send_message(message.chat.id, "দয়া করে মেনু থেকে সঠিক অপشن সিলেক্ট করুন অথবা টাস্ক সাবমিট করুন।")
...
if __name__ == "__main__":
    import threading
    threading.Thread(target=lambda: bot.infinity_none_stop()).start()
