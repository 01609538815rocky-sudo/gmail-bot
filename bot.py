...
def handle_messages(message):
    ...
    elif "TRX" in message.text.upper() or "TrxID" in message.text or len(message.text) > 5:
...
if __name__ == "__main__":
    import threading
    # ব্যাকগ্রাউন্ডে টেলিগ্রাম বট রান করার জন্য থ্রেড
    threading.Thread(target=lambda: bot.infinity_none_stop()).start()
    # Render-এর জন্য ফ্লাস্ক সার্ভার পোর্ট বাইন্ডিং
