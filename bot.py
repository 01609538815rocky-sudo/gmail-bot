...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if waiting_for_admin_pass.get(user_id, False):
        ...
        if pwd == ADMIN_PASSWORD:
            ...
            # ইউজার ভুল পাসওয়ার্ড দিলে সতর্কবার্তা পাঠানো হবে যাতে তারা আর এখানে না ঢোকে
            await update.message.reply_text("⚠️ ভুল পাসওয়ার্ড! এটি এডমিন প্যানেল। সাধারণ ব্যবহারকারীদের এখানে প্রবেশ করার অনুমতি নেই। দয়া করে নিচের মেনু থেকে আপনার কাজ বা অন্যান্য অপশন ব্যবহার করুন।")
        return
    ...
    if text == "📋 কাজ":
        ...
        if admin_logged_in.get(user_id, False):
            ...
            await update.message.reply_text("🔐 এটি এডমিন প্যানেল! এখানে প্রবেশের জন্য সঠিক পাসওয়ার্ড দিন:")
...
async def button_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "task_gmail" or data == "next_gmail":
        ...
        await query.edit_message_text(text=f"✅ সফল! আপনার {method}-এ ৫০ টাকার উইথড্র রিকুয়েস্ট এডমিন প্যানেলে জমা হয়েছে।")
        ...
        if admin_logged_in.get(user_id, False):
            ...
            await query.edit_message_text(text="⚠️ আপনার এই সেকশনে প্রবেশ করার অনুমতি নেই।")
...
if __name__ == "__main__":
    ...
    print("🤖 বট সফলভাবে ২৪ ঘণ্টা লাইভ এবং সুরক্ষিত মোডে রান হচ্ছে...")
