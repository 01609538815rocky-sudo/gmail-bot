...
def handle_message(message):
    ...
    if text == "📋 কাজ":
        ...
        income = income_balances.get(chat_id, 0.0)
        bot.reply_to(message, f"💳 আপনার ইনকাম ব্যালেন্স ৳{income:.2f}। উইথড্র করার জন্য ন্যূনতম ব্যালেন্স প্রয়োজন।", parse_mode="Markdown")
        ...
        if chat_id in user_states and user_states[chat_id] == "waiting_for_details":
            lines = text.split('\n')
            first_name = "N/A"
            last_name = "N/A"
            gmail_name = "N/A"
