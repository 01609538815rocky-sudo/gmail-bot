...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if update.message:
        ...
        await update.message.reply_text("ডিমো অপশন মেন্যু:", reply_markup=reply_markup)
...
async def deposit_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.callback_query:
        ...
        keyboard = [[InlineKeyboardButton("❌ ক্যানসেল", callback_data="cancel")]]
        await update.message.reply_text("💳 ডিপোজিট প্রক্রিয়া শুরু হয়েছে。\n\nআপনার ফোন নাম্বারটি লিখুন:", reply_markup=InlineKeyboardMarkup(keyboard))
...
async def withdraw_start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.callback_query:
        ...
        keyboard = [[InlineKeyboardButton("❌ ক্যানসেল", callback_data="cancel")]]
        await update.message.reply_text("💸 উইথড্র প্রক্রিয়া শুরু হয়েছে。\n\nউত্তোলনের পরিমাণ (টাকা) কত তা লিখুন:", reply_markup=InlineKeyboardMarkup(keyboard))
...
async def cancel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    if update.callback_query:
        query = update.callback_query
        await query.answer()
        await query.edit_message_text("❌ অপারেশন বাতিল করা হয়েছে। আবার শুরু করতে /start লিখুন বা নিচের মেন্যু ব্যবহার করুন।", reply_markup=get_main_reply_keyboard())
    else:
        await update.message.reply_text("❌ অপারেশন বাতিল করা হয়েছে। আবার শুরু করতে /start লিখুন বা নিচের মেন্যু ব্যবহার করুন।", reply_markup=get_main_reply_keyboard())
