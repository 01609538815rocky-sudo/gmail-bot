...
const app = express();
const BOT_TOKEN = process.env.BOT_TOKEN || '8860755134:AAGESglo0BDU4JQVISnEcn2mgygOIH_HMSA';
const bot = new Telegraf(BOT_TOKEN);

app.use(express.json());
app.use(express.urlencoded({ extended: true }));

// ব্লু-গোল্ড থিমের প্রিমিয়াম ইউজার ইন্টারফেস (HTML)
app.get('/', (req, res) => {
  res.send(`
    <!DOCTYPE html>
    <html lang="bn">
    <head>
        ...
        <title>Gmail Sell - Mini App</title>
        <style>
...
// টেলিগ্রাম বট কমান্ড হ্যান্ডলিং
bot.start((ctx) => {
