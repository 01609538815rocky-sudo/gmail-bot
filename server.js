...
<script>
    ...
    function initApp() {
        ...
        document.getElementById('startBtn').onclick = checkFirstTimeUser;
        document.getElementById('regSubmitBtn').onclick = handleRegister;
        document.getElementById('loginSubmitBtn').onclick = handleLogin;
        document.getElementById('toLoginText').onclick = showLoginScreen;
        document.getElementById('toRegText').onclick = showRegisterScreen;
        document.getElementById('goToBalanceBtn').onclick = () => showScreen('balanceScreen');
        document.getElementById('taskSubmitBtn').onclick = submitTask;
        document.getElementById('taskBackBtn').onclick = () => showScreen('homeScreen');
        document.getElementById('goToWithdrawBtn').onclick = () => showScreen('withdrawScreen');
        document.getElementById('balHomeBtn').onclick = () => showScreen('homeScreen');
        document.getElementById('withdrawSubmitBtn').onclick = handleWithdraw;
        document.getElementById('wdHomeBtn').onclick = () => showScreen('homeScreen');
        document.getElementById('cameraBadgeBtn').onclick = () => document.getElementById('picUploadInput').click();
        document.getElementById('picUploadInput').onchange = handleImageUpload;
        document.getElementById('profileUpdateBtn').onclick = updateUserProfile;
        document.getElementById('logoutBtn').onclick = logout;
        document.getElementById('adminBtn').onclick = checkAdminPassword;
        document.getElementById('adminUpdateRatesBtn').onclick = updateTaskRates;
        document.getElementById('adminHomeBtn').onclick = () => showScreen('homeScreen');
