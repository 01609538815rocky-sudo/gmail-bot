...
<div class="container">
    ...
    <div id="splashScreen" class="screen active">
        <div style="text-align:center; margin-top:80px;">
            ...
            <button type="button" onclick="checkFirstTimeUser()">শুরু করুন</button>
        </div>
    </div>
        ...
        try {
            ...
            data.tasks.filter(t => t.status === 'pending').forEach(t => {
                listHTML += '<div class="card" style="text-align:left; font-size:12px; background:#f9f9f9;">' +
                    ...
                    '<div style="margin-top:8px; display:flex; gap:5px;">' +
                        '<button type="button" style="padding:6px; margin:0;" onclick="reviewTask(\'' + t.id + '\', \'approve\')">Approve</button>' +
                        '<button type="button" style="padding:6px; margin:0; background:#c0392b;" onclick="reviewTask(\'' + t.id + '\', \'reject\')">Reject</button>' +
                    '</div>' +
                '</div>';
            });
            ...
            data.withdraws.filter(w => w.status === 'pending').forEach(w => {
                wdHTML += '<div class="card" style="text-align:left; font-size:12px; background:#f1f8e9;">' +
                    ...
                    '<div style="margin-top:8px; display:flex; gap:5px;">' +
                        '<button type="button" style="padding:6px; margin:0;" onclick="reviewWithdraw(\'' + w.id + '\', \'approve\')">Approve</button>' +
                        '<button type="button" style="padding:6px; margin:0; background:#c0392b;" onclick="reviewWithdraw(\'' + w.id + '\', \'reject\')">Reject</button>' +
                    '</div>' +
                '</div>';
            });
