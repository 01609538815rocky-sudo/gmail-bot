...
<div class="container">
    ...
    <div id="authScreen" class="screen">
        ...
        <p style="font-size:11px; color:#666; text-align:center;">একই তথ্য দিয়ে দ্বিতীয়বার অ্যাকাউন্ট খোলা যাবে না।</p>
...
// ব্যাকএন্ড এপিআই লজিক (নিরাপদ ও ম্যানুয়াল কন্ট্রোল)
app.post('/api/auth', (req, res) => {
    const { name, phone, email, password } = req.body;
    const existing = users.find(u => u.phone === phone);
    if (existing) {
        return res.status(400).json({ success: false, message: 'এই ফোন নম্বর দিয়ে ইতিমধ্যে অ্যাকাউন্ট খোলা হয়েছে! পুনরায় খোলা যাবে না।' });
    }
    const newUser = { 
...
app.post('/api/admin/review', (req, res) => {
    ...
    if(task) {
        ...
        if(action === 'approve') {
            ...
            res.json({ success: true, message: 'টাস্ক সফলভাবে Approve করা হয়েছে এবং ইউজার ব্যালেন্স যোগ হয়েছে।' });
