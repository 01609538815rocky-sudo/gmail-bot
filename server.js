...
<script>
    ...
    function checkFirstTimeUser() {
        ...
        if(isRegisteredBefore) {
            showScreen('loginScreen'); // একবার রেজিস্ট্রেশন করা থাকলে সরাসরি লগইন পেজে যাবে
        } else {
            showScreen('registerScreen'); // প্রথমবার হলে রেজিস্ট্রেশন পেজে যাবে
        }
    }
    ...
    async function handleRegister() {
        ...
        if(data.success) {
            ...
            localStorage.setItem('isRegisteredBefore', 'true'); // সেভ হয়ে গেল যে একবার রেজিস্ট্রেশন করা হয়েছে
            showScreen('homeScreen');
        }
    }
    ...
    function logout() {
        ...
        // નોંધ: isRegisteredBefore রিমুভ করা হয়নি, কারণ ইউজার একবার রেজিস্ট্রেশন করায় সে পরবর্তীতে লগইন পেজেই যাবে।
        location.reload();
    }
