...
<div class="container">
    ...
    <div id="homeScreen" class="screen">
        ...
        <button onclick="showScreen('balanceScreen'); updateBalanceUI();" style="background: linear-gradient(135deg, #0088cc, #00aced); margin-bottom: 12px; font-size: 14px;">📊 কাজের হিস্টরি ও ওয়ালেট দেখুন</button>
