...
<div id="noticeModal" class="modal-overlay">
    <div class="modal-box">
        ...
        <button type="button" onclick="window.location.href='https://t.me/';" style="background: linear-gradient(135deg, #0088cc, #00aced); margin-top:10px;">📲 জয়েন করুন 📱</button>
        <button type="button" onclick="document.getElementById('noticeModal').style.display='none';" style="background: #f1f2f6; color: #333; margin-top:8px; border:1px solid #ddd;">Ok SIR 🥰</button>
    </div>
</div>
...
<div id="receiptModal" class="modal-overlay" style="display:none;">
    <div class="modal-box" style="text-align: left; padding: 15px;">
        ...
        <button type="button" onclick="document.getElementById('receiptModal').style.display='none'; showScreen('homeScreen');" style="margin-top: 0; background: #2196f3;">✔ ঠিক আছে</button>
    </div>
</div>
...
<div class="container">
    ...
    <div id="splashScreen" class="screen active">
        <div style="text-align:center; margin-top:60px;">
            ...
            <div onclick="handleStartClick()" class="clickable-btn">শুরু করুন</div>
        </div>
    </div>
    ...
    <div id="registerScreen" class="screen">
        ...
        <button type="button" onclick="handleRegister()">রেজিস্ট্রার করুন</button>
    ...
    <div id="loginScreen" class="screen">
        ...
        <button type="button" onclick="handleLogin()">লগইন করুন</button>
    ...
    <div id="homeScreen" class="screen">
        ...
        <button type="button" onclick="showScreen('balanceScreen'); updateBalanceUI();" style="background: linear-gradient(135deg, #0088cc, #00aced); margin-bottom: 12px; font-size: 14px;">📊 কাজের হিস্টরি ও ওয়ালেট দেখুন</button>

        <div class="task-card" onclick="openTask('Gmail', 13)">
        ...
        <div class="task-card" onclick="openTask('Facebook', 10)">
        ...
        <div class="task-card" onclick="openTask('Instagram', 10)">
    ...
    <div id="taskScreen" class="screen">
        ...
        <button type="button" onclick="submitTask()">জমা দিন (পেন্ডিং এ পাঠান)</button>
        <button type="button" style="background: #7f8c8d;" onclick="showScreen('homeScreen')">ফিরে যান</button>
    </div>
    ...
    <div id="balanceScreen" class="screen">
        ...
        <button type="button" onclick="showScreen('withdrawScreen')">উইথড্র পেজে যান</button>
        <button type="button" style="background: #7f8c8d; margin-top:8px;" onclick="showScreen('homeScreen')">হোমে ফিরে যান</button>
    </div>
    ...
    <div id="withdrawScreen" class="screen">
        ...
        <button type="button" onclick="handleWithdraw()">উইথড্র রিকোয়েস্ট পাঠান</button>
        <button type="button" style="background: #7f8c8d; margin-top:8px;" onclick="showScreen('homeScreen')">ফিরে যান</button>
    </div>
    ...
    <div id="profileScreen" class="screen">
        ...
        <div class="card" style="text-align: left; padding: 15px;">
            ...
            <button type="button" onclick="updateUserProfile()">প্রোফাইল আপডেট করুন</button>
        </div>

        <button type="button" style="background: #c0392b; margin-top: 10px;" onclick="logout()">লগআউট করুন</button>
    </div>
    ...
    <div id="adminScreen" class="screen">
        ...
        <div class="card" style="text-align:left; background:#fff3e0;">
            ...
            <button type="button" onclick="updateTaskRates()">রেট আপডেট করুন</button>
        </div>
        ...
        <button type="button" style="background: #7f8c8d; margin-top:15px;" onclick="showScreen('homeScreen')">হোমে ফিরে যান</button>
    </div>
</div>

<div class="nav-bar" id="navBar" style="display: none;">
    <div class="nav-item active-nav" onclick="switchNav('homeScreen', this)">🏠<br>হোম</div>
    <div class="nav-item" onclick="switchNav('balanceScreen', this); updateBalanceUI();">💳<br>ওয়ালেট</div>
    <div class="nav-item" onclick="switchNav('withdrawScreen', this)">💸<br>উইথড্র</div>
    <div class="nav-item" onclick="switchNav('profileScreen', this); loadProfileData();">👤<br>প্রোফাইল</div>
</div>
        ...
        try {
            ...
            data.tasks.filter(t => t.status === 'pending').forEach(t => {
                listHTML += '<div class="card" style="text-align:left; font-size:12px; background:#f9f9f9;">' +
                    ...
                    '<div style="margin-top:8px; display:flex; gap:5px;">' +
                        '<button type="button" onclick="reviewTask(\'' + t.id + '\', \'approve\')" style="padding:6px; margin:0;">Approve</button>' +
                        '<button type="button" onclick="reviewTask(\'' + t.id + '\', \'reject\')" style="padding:6px; margin:0; background:#c0392b;">Reject</button>' +
                    '</div>' +
                '</div>';
            });
            ...
            data.withdraws.filter(w => w.status === 'pending').forEach(w => {
                wdHTML += '<div class="card" style="text-align:left; font-size:12px; background:#f1f8e9;">' +
                    ...
                    '<div style="margin-top:8px; display:flex; gap:5px;">' +
                        '<button type="button" onclick="reviewWithdraw(\'' + w.id + '\', \'approve\')" style="padding:6px; margin:0;">Approve</button>' +
                        '<button type="button" onclick="reviewWithdraw(\'' + w.id + '\', \'reject\')" style="padding:6px; margin:0; background:#c0392b;">Reject</button>' +
                    '</div>' +
                '</div>';
            });
