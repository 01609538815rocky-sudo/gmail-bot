...
<div id="noticeModal" class="modal-overlay">
    <div class="modal-box">
        ...
        <button id="tgJoinBtn" style="background: linear-gradient(135deg, #0088cc, #00aced); margin-top:10px;">📲 জয়েন করুন 📱</button>
        <button id="okSirBtn" style="background: #f1f2f6; color: #333; margin-top:8px; border:1px solid #ddd;">Ok SIR 🥰</button>
    </div>
</div>
...
<div id="receiptModal" class="modal-overlay" style="display:none;">
    <div class="modal-box" style="text-align: left; padding: 15px;">
        ...
        <button id="receiptCloseBtn" style="margin-top: 0; background: #2196f3;">✔ ঠিক আছে</button>
    </div>
</div>
...
<div class="container">
    <div class="header-top" id="topHeader" style="display:none;">
        ...
        <span id="adminBtn" style="cursor:pointer; font-size:13px; background:rgba(0,0,0,0.2); padding:4px 8px; border-radius:4px;">⋮ এডমিন</span>
    </div>
    ...
    <div id="registerScreen" class="screen">
        ...
        <button id="regSubmitBtn">রেজিস্ট্রার করুন</button>
        <div class="switch-text" id="toLoginText">আগে থেকেই অ্যাকাউন্ট আছে? <span>লগইন করুন</span></div>
    </div>
    ...
    <div id="loginScreen" class="screen">
        ...
        <button id="loginSubmitBtn">লগইন করুন</button>
        <div class="switch-text" id="toRegText">নতুন অ্যাকাউন্ট খুলতে চান? <span>রেজিস্ট্রেশন করুন</span></div>
    </div>
    ...
    <div id="homeScreen" class="screen">
        ...
        <button id="goToBalanceBtn" style="background: linear-gradient(135deg, #0088cc, #00aced); margin-bottom: 12px; font-size: 14px;">📊 কাজের হিস্টরি ও ওয়ালেট দেখুন</button>

        <div class="task-card" data-platform="Gmail" data-reward="${taskRates.gmail}">
        ...
        <div class="task-card" data-platform="Facebook" data-reward="${taskRates.facebook}">
        ...
        <div class="task-card" data-platform="Instagram" data-reward="${taskRates.instagram}">
    ...
    <div id="taskScreen" class="screen">
        ...
        <button id="taskSubmitBtn">জমা দিন (পেন্ডিং এ পাঠান)</button>
        <button style="background: #7f8c8d;" id="taskBackBtn">ফিরে যান</button>
    </div>
    ...
    <div id="balanceScreen" class="screen">
        ...
        <button id="goToWithdrawBtn">উইথড্র পেজে যান</button>
        <button style="background: #7f8c8d; margin-top:8px;" id="balHomeBtn">হোমে ফিরে যান</button>
    </div>
    ...
    <div id="withdrawScreen" class="screen">
        ...
        <button id="withdrawSubmitBtn">উইথড্র রিকোয়েস্ট পাঠান</button>
        <button style="background: #7f8c8d; margin-top:8px;" id="wdHomeBtn">ফিরে যান</button>
    </div>
    ...
    <div id="profileScreen" class="screen">
        ...
        <div class="card" style="text-align: left; padding: 15px;">
            ...
            <button id="profileUpdateBtn">প্রোফাইল আপডেট করুন</button>
        </div>

        <button style="background: #c0392b; margin-top: 10px;" id="logoutBtn">লগআউট করুন</button>
    </div>
    ...
    <div id="adminScreen" class="screen">
        ...
        <div class="card" style="text-align:left; background:#fff3e0;">
            ...
            <button id="adminUpdateRatesBtn">রেট আপডেট করুন</button>
        </div>
        ...
        <button style="background: #7f8c8d; margin-top:15px;" id="adminHomeBtn">হোমে ফিরে যান</button>
    </div>
</div>

<div class="nav-bar" id="navBar" style="display: none;">
    <div class="nav-item active-nav" data-screen="homeScreen">🏠<br>হোম</div>
    <div class="nav-item" data-screen="balanceScreen">💳<br>ওয়ালেট</div>
    <div class="nav-item" data-screen="withdrawScreen">💸<br>উইথড্র</div>
    <div class="nav-item" data-screen="profileScreen">👤<br>প্রোফাইল</div>
</div>
...
<script>
    ...
    window.addEventListener('DOMContentLoaded', () => {
        ...
        // Event Listeners for buttons to ensure 100% responsiveness in WebView
        document.getElementById('okSirBtn').addEventListener('click', () => {
        ...
        document.getElementById('tgJoinBtn').addEventListener('click', () => {
        ...
        document.getElementById('startBtn').addEventListener('click', checkFirstTimeUser);
        document.getElementById('regSubmitBtn').addEventListener('click', handleRegister);
        document.getElementById('loginSubmitBtn').addEventListener('click', handleLogin);
        document.getElementById('toLoginText').addEventListener('click', showLoginScreen);
        document.getElementById('toRegText').addEventListener('click', showRegisterScreen);
        document.getElementById('goToBalanceBtn').addEventListener('click', () => showScreen('balanceScreen'));
        document.getElementById('taskSubmitBtn').addEventListener('click', submitTask);
        document.getElementById('taskBackBtn').addEventListener('click', () => showScreen('homeScreen'));
        document.getElementById('goToWithdrawBtn').addEventListener('click', () => showScreen('withdrawScreen'));
        document.getElementById('balHomeBtn').addEventListener('click', () => showScreen('homeScreen'));
        document.getElementById('withdrawSubmitBtn').addEventListener('click', handleWithdraw);
        document.getElementById('wdHomeBtn').addEventListener('click', () => showScreen('homeScreen'));
        document.getElementById('cameraBadgeBtn').addEventListener('click', () => document.getElementById('picUploadInput').click());
        document.getElementById('picUploadInput').addEventListener('change', handleImageUpload);
        document.getElementById('profileUpdateBtn').addEventListener('click', updateUserProfile);
        document.getElementById('logoutBtn').addEventListener('click', logout);
        document.getElementById('adminBtn').addEventListener('click', checkAdminPassword);
        document.getElementById('adminUpdateRatesBtn').addEventListener('click', updateTaskRates);
        document.getElementById('adminHomeBtn').addEventListener('click', () => showScreen('homeScreen'));

        document.querySelectorAll('.task-card').forEach(card => {
            card.addEventListener('click', () => {
                openTask(card.getAttribute('data-platform'), Number(card.getAttribute('data-reward')));
            });
        });
