        ...
        <style>
            * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; }
            ...
            .logo-circle {
                ...
                font-size: 38px; font-weight: bold; color: #070d1f;
    ...
    <body>
        <div class="phone-frame">
            <div class="header">
                ...
                <span style="cursor: pointer;" onclick="showPage('admin-page', 'এডমিন ও সিকিউরিটি প্যানেল')">⚙️</span>
            </div>
            ...
            <div class="content">
                ...
                <div id="login-page" class="page">
                    ...
                    <button class="btn" onclick="showPage('home-page', 'ওপেন অ্যাপস')">রেজিস্ট্রেশন / লগইন</button>
                </div>
                ...
                <div id="task-form-page" class="page">
                    ...
                    <div class="form-group">
                        <label>একাউন্ট ডিটেইলস / জিমেইল</label>
                    ...
                    <button class="btn" onclick="alert('সফলভাবে সাবমিট হয়েছে!'); showPage('home-page', 'ওপেন অ্যাপস');">সাবমিট</button>
                </div>

                <!-- 5. BALANCE & WITHDRAW PAGE -->
                <div id="balance-page" class="page">
                    <div class="hero-banner">
                        <h3>মিനിമাম উইথড্র ৫০ টাকা</h3>
                    </div>
                    <div class="form-group">
                    ...
                    <button class="btn" onclick="alert('উইথড্র রিকোয়েস্ট সফলভাবে পাঠানো হয়েছে!')">উইথড্র সাবমিট</button>
                </div>
                ...
                <div id="profile-page" class="page">
                    ...
                    <div style="background: rgba(255,255,255,0.04); padding: 12px; border-radius: 10px; border: 1px solid rgba(212,175,55,0.3); margin-bottom: 12px; font-size: 12px;">
                        <p style="margin-bottom: 6px;"><b>Name:</b> Rocky</p>
                        <p style="margin-bottom: 6px;"><b>User ID:</b> 3000100</p>
                        <p style="margin-bottom: 6px;"><b>Email:</b> bdtvibe@gmail.com</p>
                        <p><b>Status:</b> 100% সুরক্ষিত</p>
                    </div>
                    <button class="btn-outline" onclick="showPage('login-page', 'Registration / Login')">লগআউট (Log Out)</button>
                </div>

                <!-- 7. ADMIN / SECURITY PAGE -->
                <div id="admin-page" class="page">
                    <div style="text-align: center; margin-bottom: 15px;">
                        <div style="font-size: 32px; margin-bottom: 5px;">🛡️</div>
                        <h4 style="color: #d4af37; font-size: 14px;">100% সুরক্ষিত এডমিন কন্ট্রোল</h4>
                    </div>
                    <div style="background: rgba(255,255,255,0.04); padding: 12px; border-radius: 10px; border: 1px solid rgba(212,175,55,0.3); font-size: 12px; text-align: center;">
                        <p style="color: #b0c4de; margin-bottom: 10px;">সকল সাবমিশন ও উইথড্র রিকোয়েস্ট নিরাপদ রাখা হয়েছে।</p>
                        <button class="btn" onclick="showPage('home-page', 'ওপেন অ্যাপস')">হোমে ফিরে যান</button>
                    </div>
                </div>
            </div>
